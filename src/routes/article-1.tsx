...
export const Route = createFileRoute("/article-1")({
    ...
    <main style={{ background: BG, color: FG, minHeight: "100vh" }}>
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "120px 24px" }}>
        ...
        <p style={{
          ...
          A curated overview of modern LED systems, from efficiency gains to
          architectural integrations. This page is ready for your full article
