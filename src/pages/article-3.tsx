/* =============================================================
   article-3.tsx — Static Article Page
   =============================================================
   Purpose   : Renders a static article about Lighting for Modern Homes.
   Used by   : Router (mapped to /article-3)
  ...
  return (
    <main style={{ background: BG, color: FG, minHeight: "100vh" }}>
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "120px 24px" }}>
        ...
        >
          A snapshot of layered lighting, smart controls, and warm minimalism. This page is ready
          for your full article content whenever you are.
        </p>
