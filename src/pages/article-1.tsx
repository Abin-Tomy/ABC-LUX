/* =============================================================
   article-1.tsx — Static Article Page
   =============================================================
   Purpose   : Renders a static article about LED lighting essentials.
   Used by   : Router (mapped to /article-1)
  ...
  return (
    <main style={{ background: BG, color: FG, minHeight: "100vh" }}>
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "120px 24px" }}>
        ...
        >
          A curated overview of modern LED systems, from efficiency gains to architectural
          integrations. This page is ready for your full article content whenever you are.
        </p>
