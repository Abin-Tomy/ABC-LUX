/* =============================================================
   Feedback.tsx — Testimonials/Feedback Section
   =============================================================
   Purpose   : Displays client testimonials in a custom Swiper carousel with floating background avatars.
   Used by   : Home page index.tsx
   Depends on: react, swiper, TitleReveal
   Notes     : Uses a complex layered layout with SVG paths, CSS animations for floating avatars, and Swiper for the main carousel.
   ============================================================= */
...
const ITEMS: TestimonialItem[] = [
  {
    ...
    name: "Ajmal Roshan K",
    role: "Client",
    body: "Found the perfect chandelier for my living room. Great quality, reasonable pricing, and excellent support from the ABC LUX team.",
    stars: 5,
    size: "large",
  ...
  },
  {
    ...
    name: "Umer Hayat",
    role: "Client",
    body: "Professional service, trendy designs, and quick delivery. ABC LUX made lighting selection easy and enjoyable for our entire office space.",
    stars: 5,
    size: "medium",
  ...
  },
  {
    ...
    name: "Suhaila K",
    role: "Client",
    body: "Visited many stores, but ABC LUX stood out. Unique pieces, helpful staff, great value, and amazing overall experience. Truly satisfied with my purchase",
    stars: 5,
    size: "small",
...
/**
 * Stars
 * Helper component rendering a row of 5 stars based on a rating count.
 * Props:
...
/**
 * Avatar
 * Renders an avatar circle which can contain either an image or an initial.
 * Used both in the central testimonial focus and the floating background elements.
 * Props:
 * - initial: Letter to display if no image
 * - size: Pixel size of the avatar
 * - bg: Background color
 * - border: CSS border string
 * - fontSize: Pixel size for the initial text
 * - color: Text color
 ...
 * Features a central Swiper carousel and decorative, floating avatar elements in the background.
 * Props: None
 */
