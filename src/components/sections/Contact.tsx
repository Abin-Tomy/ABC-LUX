    ...
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
      ...
      >
        <div className="flex flex-col items-center text-center">
          <div className={`mb-6 flex h-16 w-16 items-center justify-center rounded-full ${type === 'success' ? 'bg-green-500/10 text-green-500' : 'bg-red-500/10 text-red-500'}`}>
            {type === 'success' ? (
    ...
    try {
      ...
      if (response.ok) {
        setDialog({
          ...
          message: result.message || 'Thank you for reaching out. We have received your message and will get back to you shortly.',
        });
          ...
          <div className="grid grid-cols-1 gap-16 md:grid-cols-[0.9fr_1.1fr]">
            <div>
              <h2 className="font-serif text-[12vw] leading-[0.92] tracking-[-0.03em] md:text-[6vw]">
                ...
                <TitleReveal text="In Touch With Us" className="font-light italic text-ember" waitForPreloader={false} />
              </h2>
              ...
              <div className="mt-12 space-y-4">
                <div className="flex items-start gap-3">
                  <svg className="h-5 w-5 text-ember mt-0.5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                  <div className="font-serif text-lg text-foreground">Shop No. 5, Zone 43, Street, 340 Salwa Road, Doha</div>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="h-5 w-5 text-ember" fill="currentColor" viewBox="0 0 24 24"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-4.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/></svg>
                  <div className="font-serif text-lg text-foreground">8:00 AM To 10:00 PM</div>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="h-5 w-5 text-ember" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
                  <div className="font-serif text-lg text-foreground">info@abclux.qa</div>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="h-5 w-5 text-ember" fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
