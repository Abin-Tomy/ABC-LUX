/* =============================================================
   ...
   =============================================================
   Purpose   : Showcases company values using an intricate, math-driven scroll animation (stacking cards).
   Used by   : Home page index.tsx
   Depends on: react, TitleReveal
   Notes     : Relies heavily on custom lerp/phase math mapped to scroll progress rather than GSAP timelines, creating a unique card-shuffling effect.
   ============================================================= */
...
/**
 * WhyChooseUs
 * Renders a sticky scroll sequence where title text splits apart to reveal a deck of cards that shuffle and stack.
 * Props: None
 */
