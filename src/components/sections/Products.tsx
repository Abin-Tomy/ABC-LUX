/* =============================================================
   ...
   =============================================================
   Purpose   : Displays a horizontal scrolling ribbon of product categories tied to vertical scroll progress.
   Used by   : Home page index.tsx
   Depends on: react, react-router-dom, gsap, useLenis
   Notes     : On desktop, uses a sticky container and translates cards horizontally based on scroll. On mobile, falls back to a free-scrolling horizontal ribbon or touch-drag implementation.
   ============================================================= */
...
/**
 * useScrollProgress
 * Custom hook to calculate the scroll progress (0 to 1) of a given container relative to the viewport.
 * Props:
 * - ref: React RefObject pointing to the scrollable container.
...
/**
 * Testimonials
 * Renders the product category cards. Features horizontal scroll tracking on desktop and touch-draggable physics on mobile.
 * Note: Component named Testimonials but used for Products.
 * Props: None
 */
