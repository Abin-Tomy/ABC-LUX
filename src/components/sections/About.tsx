...
export function About() {
  ...
  return (
    ...
    >
      <div
        className="mx-auto w-full max-w-[1400px] relative z-10 pt-20 md:pt-24 lg:pt-32"
        ref={containerRef}
      >
        <div className="lux-about-grid grid grid-cols-1 items-center lg:items-start gap-16 lg:grid-cols-[1.2fr_0.8fr] md:gap-20 lg:gap-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 w-full pt-4">
              ...
              <div className="reveal-text flex flex-col gap-4 group">
                ...
                <p className="text-[13px] md:text-sm leading-relaxed text-[#F5F0E8]/50 max-w-[300px] mx-auto lg:mx-0">
                  To provide high-quality, innovative, and affordable lighting solutions that
                  enhance homes and businesses while ensuring customer satisfaction through
              ...
              <div className="reveal-text flex flex-col gap-4 group">
                ...
                <p className="text-[13px] md:text-sm leading-relaxed text-[#F5F0E8]/50 max-w-[300px] mx-auto lg:mx-0">
                  ...
                  excellence, offering cutting-edge lighting solutions that brighten every space.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative group w-full mt-12 lg:mt-0 flex justify-center lg:justify-end order-2">
            ...
            <div className="lux-exp-card reveal-text absolute -bottom-6 md:-bottom-10 lg:-bottom-12 -right-2 md:-right-6 lg:-right-8 bg-[#C9A962] p-5 md:p-8 lg:p-10 rounded-3xl md:rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] w-[85%] max-w-[260px] md:max-w-[320px] lg:max-w-[360px] border border-white/10">
              <div className="grid grid-cols-2 gap-4 md:gap-8 lg:gap-10 text-[#0E0D0E]">
                <div className="flex flex-col gap-0.5">
                  <div className="text-2xl md:text-3xl lg:text-4xl font-bold font-serif tracking-tight">
                    7+
                  </div>
                  <div className="text-[8px] md:text-[10px] lg:text-[11px] uppercase tracking-widest font-semibold opacity-70 leading-tight">
                    Years of
                    <br />
                    Experience
                  </div>
