          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#F1EBDD]/10 text-[#F1EBDD] transition-colors duration-500 ease-out hover:bg-ember hover:text-obsidian"
                target="_blank"
