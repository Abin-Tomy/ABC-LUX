/* =============================================================
   ...
   =============================================================
   Purpose   : Renders the sticky top navigation header, including logo and menu toggle.
   Used by   : Home page index.tsx (and potentially RootLayout)
   Depends on: react, gsap, MenuOverlay
   Notes     : Automatically switches logo color (black/white) based on the background color of the section currently under it.
   ============================================================= */
 ...
 * Uses a GSAP ticker to monitor scroll position and adjust the logo color dynamically to ensure contrast against dark/light sections.
 * Props: None
 */
export function Nav() {
